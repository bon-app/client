...
export class DynamicFormFieldConfig implements FormlyFieldConfig {
    ...
    list: DynamicListOptions = new DynamicListOptions();

    static fromJson(json: any) {
        let field = new DynamicFormFieldConfig();
...
export class DynamicListOptions {
    parser: ((value: any, ...args: any[]) => any) | string = (value) => value;
